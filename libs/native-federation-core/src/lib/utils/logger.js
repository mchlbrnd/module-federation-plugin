...
log.addLevel('warn', levels.info, { fg: 'brightWhite', bg: 'yellow' }, ' WARN ');
log.addLevel('info', levels.warn, { fg: 'brightWhite', bg: 'green' }, ' INFO ');
log.addLevel('notice', levels.notice, { fg: 'black', bg: 'brightYellow' }, ' NOTE ');
log.addLevel('verbose', levels.verbose, { fg: 'brightWhite', bg: 'brightBlue' }, ' VRB! ');
